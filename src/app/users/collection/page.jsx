    ...
    const handleDelete = async (id) => {
        try {
            ...
            if (response.ok) {  
                ...
                console.error("Gagal menghapus koleksi.");
            }
        } catch (error) {
    ...
    return (
        <div className="mt-12 text-color-primary flex flex-col lg:flex-row items-start lg:items-center justify-between px-8 min-h-[70vh]">
            <div className="lg:w-3/5 mb-8 lg:mb-0">
                ...
                <p className="text-xl text-color-accent">Bahasa arkais yang kamu koleksi</p>
                <div className="py-8">
                    <Link
                        href="/"
            ...
            <div className="w-full max-w-4xl mt-12 lg:mt-16 overflow-y-scroll max-h-[50vh] scrollbar-hidden">
                <h3 className="text-2xl font-semibold text-color-primary">Koleksi kamu</h3>

                {collections.length > 2 && (
                    <h5 className='text-xl my-2'>Gulir ke bawah untuk melihat selengkapnya</h5>
                )}
                ...
                <div className="flex flex-col space-y-6">
                    {collections.length > 0 ? (
                        collections.map((item, index) => {
                            ...
                            return (
                                <div key={index} className="bg-color-secondary p-6 rounded-lg shadow-lg flex justify-between items-center">
                                    <div>
